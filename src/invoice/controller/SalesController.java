...
import invoice.model.InvoiceLine;
import invoice.model.InvoiceLinesTableModel;
import invoice.view.Frame;
import invoice.view.InvHeaderDialog;
import invoice.view.InvLineDialog;
...
public class SalesController implements ActionListener,ListSelectionListener  {
    ...
    public SalesController(Frame frame) {
        this.frame = frame;
    }
    ...
    private void createInvoiceOK() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(frame, "Wrong date format Enter it as dd/mm/yyyy", "Error", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
        displayInvoices();
    }
